...
contract MyERC1155Token is ERC1155, Ownable {
    ...
    constructor() ERC1155("ipfs://bafybeiaan5hx3tfk4vs4qp3l7efg2dyydlt3mjs7egduhlsuwylafnlrrm/{id}") Ownable(msg.sender){}

    function mint(uint256 id, uint256 amount) public {
        require(id >= TOKEN_0 && id <= TOKEN_2, "Free minting is allowed only for token IDs 0-2");
        require(block.timestamp >= lastMintTime[msg.sender][id] + 1 minutes, "There is a cooldown of 1 minute between free mints.");
    ...
    function forgeMint(address to, uint256 id, uint256 amount) public  {
        ...
        require(id >= TOKEN_3 && id <= TOKEN_6, "Using forgeMint, you can only mint IDs 3-6. ");
        _mint(to, id, amount, "");
    }
